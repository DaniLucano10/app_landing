          ...
          <div>
            ...
            <Link href="/">
              <h1 className="text-xl md:text-3xl font-extrabold cursor-pointer">
                <span className="text-3xl md:text-4xl text-pink-700">L</span>
                ideraTec
              </h1>
            </Link>
            {/* Description */}
            <p className="mt-4 text-sm font-medium leading-[2rem] w-[90%] text-gray-600">
              En LideraTec impulsamos la productividad de equipos modernos con
              soluciones digitales intuitivas y colaborativas. Nuestra
              plataforma está diseñada para optimizar el flujo de trabajo, sin
