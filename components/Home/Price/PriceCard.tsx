        ...
        <div className='bg-white p-12 rounded-lg shadow-lg'>
            ...
            <div className='mt-10'>
                <div className='text-center mb-4 flex items-center space-x-3'>
                    ...
                    <p className='text-sm font-semibold text-gray-700'>Conexión ilimitada</p>
                </div>
                <div className='text-center mb-4 flex items-center space-x-3'>
                    <div className='text-center w-8 h-8 bg-gray-300 rounded-full justify-center flex items-center flex-col'>
                        <FaCheck className='text-green-500' />
                    </div>
                    <p className='text-sm font-semibold text-gray-700'>Acciones básicas y desencadenadores</p>
                </div>
                <div className='text-center mb-4 flex items-center space-x-3'>
                    <div className='text-center w-8 h-8 bg-gray-300 rounded-full justify-center flex items-center flex-col'>
                        <FaCheck className='text-green-500' />
                    </div>
                    <p className='text-sm font-semibold text-gray-700'>Pagos en borrador</p>
                </div>
                <div className='text-center mb-4 flex items-center space-x-3'>
                    <div className='text-center w-8 h-8 bg-gray-300 rounded-full justify-center flex items-center flex-col'>
                        <FaCheck className='text-green-500' />
                    </div>
                    <p className='text-sm font-semibold text-gray-700'>Flujos y soportes ilimitados</p>
                </div>
                <div className='text-center mb-4 flex items-center space-x-3'>
                    <div className='text-center w-8 h-8 bg-gray-300 rounded-full justify-center flex items-center flex-col'>
                        <FaCheck className='text-green-500' />
                    </div>
                    <p className='text-sm font-semibold text-gray-700'>Actualizaciones de por vida</p>
                </div>
                <div className='mt-8'>
